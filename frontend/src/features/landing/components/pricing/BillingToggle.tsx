  ...
  return (
    <Tabs value={value} onValueChange={(v) => onChange(v as BillingCycle)}>
      <TabsList className="group-data-horizontal/tabs:h-auto gap-1 rounded-full border border-border bg-surface p-1.5">
        <TabsTrigger
          value="monthly"
          className="h-auto rounded-full px-6 py-2 text-body-base font-semibold text-muted-foreground data-active:bg-primary data-active:text-primary-fg"
        >
          Monthly
        </TabsTrigger>
        <TabsTrigger
          value="annual"
          className="h-auto gap-2 rounded-full px-6 py-2 text-body-base font-semibold text-muted-foreground data-active:bg-primary data-active:text-primary-fg"
        >
          Annual
          <Typography
            as="span"
